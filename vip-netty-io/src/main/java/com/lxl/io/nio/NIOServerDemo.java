...
public class NIOServerDemo {
    ...
    public NIOServerDemo(int port){
        ...
        try {
            ...
            //在门口翻牌子，正在营业
			/**
			 * 创建了 ServerSocketChannel 对象，并调用
			 * configureBlocking()方法，配置为非阻塞模式，接下来的三行代码把该通道绑定到指定 端口，最后向 Selector
			 * 中注册事件，此处指定的是参数是 OP_ACCEPT，即指定我们想要监听 accept 事件，也就是新的连接发 生
