...
public class DataSourceConfig {
    ...
    public DataSource shardingDataSource() throws SQLException {
        ...
        src.setDefaultDataSourceName("ds11");
        // 默认的分库策略
        //src.setDefaultDatabaseShardingStrategyConfig(new StandardShardingStrategyConfiguration("user_id", DBShardAlgo.class.getName(), DBRangeShardAlgo.class.getName()));
        // 默认的分表策略
    ...
    private Map<String, DataSource> createDataSourceMap() {
        ...
        result.put("ds11", createDataSource("jdbc:mysql://localhost:3306/test?characterEncoding=utf8&useSSL=false&serverTimezone=UTC"));
        return result;
    }
    ...
    public TableRuleConfiguration getUserTableRuleConfiguration() {
        ...
        userTableRuleConfig.setDatabaseShardingStrategyConfig(new StandardShardingStrategyConfiguration("user_id", DBShardAlgo.class.getName(), DBRangeShardAlgo.class.getName()));
        ...
        // userTableRuleConfig.setKeyGeneratorColumnName("order_id"); 
        // KeyGenerotorClass：指定生成器类，默认是 DefaultKeyGenerator.java，里面使 用了雪花算法。
        // userTableRuleConfig.setKeyGeneratorClass("io.shardingsphere.core.keygen.DefaultKeyGenerator"); 
